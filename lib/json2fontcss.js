...
var scssTmpl = fs.readFileSync(templateDir + 'scss_maps.mustache.scss', 'utf8');
addMustacheTemplate('scss_maps', scssTmpl);
...
function json2fontcss(params) {
  ...
  // Add common escapes for chars and fontFamily
  params.escapedFontFamily = JSON.stringify(params.fontFamily);
